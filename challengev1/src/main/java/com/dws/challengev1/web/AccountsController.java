...
import com.dws.challengev1.service.AccountsService;
...
public class AccountsController {
  ...
  public void transfer(@RequestParam("accountFromId") String accountFromId,
                       @RequestParam("accountToId") String accountToId,
